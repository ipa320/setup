...
We setup a special bash environment to be used on the Care-O-bot pcs. The environments differ from each pc. Copy the \texttt{cob.bash.bashrc.pcX} to \texttt{/etc/cob.bash.bashrc} on each pc.
