...
\subsection{Install ROS and driver software (Hydro distro)}
...
\begin{lstlisting}
sudo apt-get update
sudo apt-get install python-setuptools ogre-tools ros-groovy-diagnostics ros-hydro-rxtools ros-hydro-pr2-* ros-hydro-rosjava-tools ros-hydro-openni*
\end{lstlisting}
