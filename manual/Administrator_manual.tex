...
\begin{lstlisting}
sudo apt-get update
sudo apt-get install vim tree gitg meld curl openjdk-6-jdk zsh terminator language-pack-de language-pack-en
\end{lstlisting}
...
\begin{lstlisting}
sudo apt-get update
sudo apt-get install python-setuptools rogre-tools os-groovy-diagnostics-monitors ros-groovy-rxtools ros-groovy-pr2-* ros-groovy-client-rosjava-jni 
\end{lstlisting}
...
rosinstall ~/git/care-o-bot https://raw.github.com/ipa-nhg/setup/master/repositories/cob_groovy.rosinstall
\end{lstlisting}
