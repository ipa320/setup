...
pdfauthor={Nadia Hammoudeh Garcia, Florian Weisshardt},pdfsubject={Manual for working with robots in the ipa-apartment},
...
\include{ipa-apartment-rules}
\include{ipa-robot-rules}
