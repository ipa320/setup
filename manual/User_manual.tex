...
\begin{figure}[!ht]
%\centering
\mbox{\subfigure{\includegraphics[width=7cm,angle=180]{images/packing_01.jpg}}\quad
\subfigure{\includegraphics[width=7cm,angle=270]{images/packing_02.jpg} }}
\caption{Step 0: Remove board and put the belt aside (left). Open the front door (right).} % \label{fig12}
\end{figure}

\begin{figure}[!ht]
\centering
\mbox{\subfigure{\includegraphics[width=7cm]{images/packing_03.jpg}}\quad
\subfigure{\includegraphics[width=7cm,angle=90]{images/packing_04.jpg} }}
...
\subfigure{\includegraphics[width=7cm]{images/packing_06.jpg} }}
...
\begin{figure}[!ht]
\centering
\mbox{\subfigure{\includegraphics[width=7cm]{images/packing_07.jpg}}\quad
...
\begin{figure}[!ht]
\centering
\mbox{\subfigure{\includegraphics[width=8cm, angle=90]{images/packing_09.jpg}}\quad
\subfigure{\includegraphics[width=7cm]{images/packing_10.jpg} }}
\caption{Step 4: Put bubble wrap around the tray and over the head.} %\label{fig12}
\end{figure}

\begin{figure}[!ht]
\centering
\mbox{\subfigure{\includegraphics[width=6cm]{images/packing_11.jpg}}\quad
\subfigure{\includegraphics[width=7cm,angle=90]{images/packing_12.jpg} }}
...
\begin{figure}[!ht]
\centering
\mbox{\subfigure{\includegraphics[width=6cm]{images/packing_13.jpg}}\quad
\subfigure{\includegraphics[width=7cm,angle=90]{images/packing_14.jpg} }}
\caption{Step 6: Pack the accessory box as shown (left) and place it in the rails (right).} % \label{fig12} 
\end{figure}

\begin{figure}[!ht]
\centering
\mbox{\subfigure{\includegraphics[width=6cm]{images/packing_20.jpg}}\quad
\subfigure{\includegraphics[width=7cm,angle=90]{images/packing_21.jpg} }}
