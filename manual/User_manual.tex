...
\subsection{Checklist first-aid box}\label{sec:firstaidbox}
...
\caption{Put bubble wrap around the hand, and put foam material between motor blocks and box (make sure contact is with the motor box and not with the robot coating), and behind and in front of the robot.} %\label{fig12}
\end{figure}
